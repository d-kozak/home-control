...
public class Client implements Runnable {
    ...
    private Sensor parseData(String szResponseLine) {
        ...
        // Parse pt.ipp.estg.home.control.sensor class
    ...
    private void updateSensorData(Sensor mSensor) {
        ...
        Log.message("Updating pt.ipp.estg.home.control.sensor data: " + mSensor.toString());
    ...
    public String generateRandomData() {
        ...
        switch (mSensor.getSensorClass()) {
            ...
            // Temperature pt.ipp.estg.home.control.sensor
            case 0:
